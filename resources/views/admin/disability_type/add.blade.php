    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Disability Type</h4>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('disabilitytype-list') }}" class="btn btn-primary light">Attendance Type list</a>
                    </li>
            ...
            <div class="card-body">
                <div class="form-validation">
                    <h5>Add Disability Type</h5>

                    <form class="needs-validation" novalidate method="POST" action="{{ route('store-disabilitytype') }}" >
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Valid Disability Type." required name="type">
                                        <div class="invalid-feedback">
                                            Please enter an Disability Type.
                                        </div>
                                    </div>
                                </div>
                                      ...
                                      <label class="row-lg-3 col-form-label" for="validationCustom03">Status <span class="text-danger">*</span></label>
                                            <div class="row-lg-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="status" value="0" id="statusCheckbox" {{ old('status') == 0 ? 'checked' : '' }}>
