                ...
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{ URL::route('students') }}">Student</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="pcoded-submenu" style="display: block;" >
                                         <li class=""><a href="surveycontactstatus-list" class="">Survey Contact Status</a></li>
                                         <li class=""><a href="disabilitytype-list" class="">Disability Types</a></li>
                                         <li class=""><a href="add-languagediversity" class="">Add Language Diversity</a></li>
                                     </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="examroutine-list">Exam Routines</a></li>
                                <li><a href="class-routine-teacher">Teacher Routines</a></li>
                                 ...
                                 <li>
                                    ...
                                    <ul class="pcoded-submenu" style="display: block;" >
                                         <li class=""><a href="routine-setting/class" class="">Class Routine</a></li>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                            <li><a href="{{ URL::route('examattendance-list') }}">Exam Attendance</a></li>
